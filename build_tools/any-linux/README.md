...
- **Rust**: Rust 1.91.1 toolchain with Cargo
- **Cross-compilation**: Direct cargo cross-compilation for ARM targets
- **Permissions**:
...
curl --proto '=https' --tlsv1.2 -sSf https://sh.rustup.rs | sh -s -- --default-toolchain 1.91.1
