...
The CI/CD pipeline uses `rust:1.91.1` image for optimal compatibility and performance:
- **Modern Toolchain**: Uses latest stable Rust
...
- Base images:
  - Rust: `rust:1.91.1` (modern stable toolchain)
